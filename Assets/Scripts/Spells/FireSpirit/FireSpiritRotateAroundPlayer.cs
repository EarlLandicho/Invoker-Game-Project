	...
	private void RotateSpiritAroundPlayer()
	{
		...
		if (fireRing1 != null)
		{
			fireRing1.transform.position = playerTransform.position +
										   new Vector3(Mathf.Sin(spiritRotationAngle), Mathf.Cos(spiritRotationAngle),
													   0) * spiritRotationRadius;
		}
		...
		if (fireRing2 != null)
		{
			fireRing2.transform.position = playerTransform.position +
										   new Vector3(Mathf.Sin(spiritRotationAngle + oneThirdOfACircle),
													   Mathf.Cos(spiritRotationAngle + oneThirdOfACircle), 0) *
		...
		if (fireRing3 != null)
		{
			fireRing3.transform.position = playerTransform.position +
										   new Vector3(Mathf.Sin(spiritRotationAngle + twoThirdsOfACircle),
													   Mathf.Cos(spiritRotationAngle + twoThirdsOfACircle), 0) *
										   spiritRotationRadius;
		}
	}
}