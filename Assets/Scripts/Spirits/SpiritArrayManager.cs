...
{
	private static SpiritArrayManager instance;
	...
	private readonly int[] spiritArray = {0, 0, 0};
	...
	{
		Debug.LogFormat("Current Amount: spirit1 {0}, spirit2 {1}, spirit3 {2}", spiritCurrentAmount1,
						spiritCurrentAmount2, spiritCurrentAmount3);
	}
}