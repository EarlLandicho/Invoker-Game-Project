...
public class OldGUIExamplesCS : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		if (GUI.Button(buttonRect1.rect, "Scale Centered"))
		{
			...
			LeanTween.move(buttonRect1,
						   new Vector2(buttonRect1.rect.x - buttonRect1.rect.width * 0.1f,
									   buttonRect1.rect.y - buttonRect1.rect.height * 0.1f), 0.25f)
					 .setEase(LeanTweenType.easeOutQuad);
		}
		...
		GUI.DrawTextureWithTexCoords(new Rect(0.8f * w, 0.5f * h - beauty.height * 0.5f, beauty.width * 0.5f, beauty.height * 0.5f),
									 beauty, beautyTileRect.rect);
