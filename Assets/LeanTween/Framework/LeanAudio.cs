...
public class LeanAudio : object
{
	...
	public static LeanAudioStream createAudioStream(AnimationCurve volume,
	 ...
	 */
	public static AudioClip createAudio(AnimationCurve volume,
										AnimationCurve frequency,
										LeanAudioOptions options = null)
	{
		if (options == null)
	...
	private static int createAudioWave(AnimationCurve volume, AnimationCurve frequency, LeanAudioOptions options)
	{
		...
		for (int i = 0; i < PROCESSING_ITERATIONS_MAX; i++)
		{
			...
			{
				Debug.LogError("LeanAudio has reached it's processing cap. To avoid this error increase the number of iterations ex: LeanAudio.PROCESSING_ITERATIONS_MAX = " +
