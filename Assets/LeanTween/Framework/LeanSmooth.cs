...
public class LeanSmooth
{
	 ...
	 */
	public static float damp(float current,
							 float target,
	 ...
	 */
	public static Vector3 damp(Vector3 current,
							   Vector3 target,
	 ...
	 */
	public static Color damp(Color current,
							 Color target,
	 ...
	 * Debug.Log("current:"+followVar);
	 */
	public static float spring(float current,
							   float target,
							   ref float currentVelocity,
							   float smoothTime,
							   float maxSpeed = -1f,
	 ...
	 * Debug.Log("current:"+transform.position);
	 */
	public static Vector3 spring(Vector3 current,
								 Vector3 target,
								 ref Vector3 currentVelocity,
								 float smoothTime,
								 float maxSpeed = -1f,
	 ...
	 *     Debug.Log("current:"+fromColor);
	 */
	public static Color spring(Color current,
							   Color target,
							   ref Color currentVelocity,
							   float smoothTime,
							   float maxSpeed = -1f,
	 ...
	 * Debug.Log("current:"+followVar);
	 */
	public static float bounceOut(float current,
								  float target,
								  ref float currentVelocity,
								  float smoothTime,
								  float maxSpeed = -1f,
	 ...
	 * Debug.Log("current:"+transform.position);
	 */
	public static Vector3 bounceOut(Vector3 current,
									Vector3 target,
									ref Vector3 currentVelocity,
									float smoothTime,
									float maxSpeed = -1f,
	 ...
	 *     Debug.Log("current:" + fromColor);
	 */
	public static Color bounceOut(Color current,
								  Color target,
								  ref Color currentVelocity,
								  float smoothTime,
								  float maxSpeed = -1f,
